...
// get book id from url params (`req.params`)
  ...
  // res.json(req.params);
  db.Book.findOneAndUpdate({_id: req.params.id},{title: req.body.title}, {author: req.body.author}, function(err,updatedBook){
    if(err) return res.send(err);
...
app.delete('/api/books/:id', function (req, res) {
  ...
  db.Book.findOneAndRemove({_id: req.params.id},function(err,book){
    if(err) return res.send(err);
    res.json(book);
  });
});
